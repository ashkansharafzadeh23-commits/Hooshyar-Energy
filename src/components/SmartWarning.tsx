...
export function SmartWarning({ monthlyKwh, targets }: { monthlyKwh: number, targets: string[] }) {
  ...
  return (
    <motion.div 
      ...
      className="mt-6 bg-white border border-[#E4E7EC] rounded-2xl p-5 sm:p-6 shadow-sm relative overflow-hidden"
    >
      ...
      <div className="flex items-start gap-4">
        <div className={`p-3 rounded-xl shrink-0 ${severity === 'high' ? 'bg-red-50 text-red-600' : severity === 'normal' ? 'bg-blue-50 text-blue-600' : 'bg-green-50 text-green-600'}`}>
          <Settings size={28} />
        </div>
        
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            <h3 className="text-lg font-black text-gray-800">هشدار هوشمند تعمیر و نگهداری</h3>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex items-center gap-2 text-sm font-bold text-gray-800 bg-gray-50 px-3 py-2 rounded-lg border border-gray-100">
            ...
            <a href="/smart-maintenance" className="text-xs font-bold text-white bg-gray-900 hover:bg-blue-600 transition-colors px-4 py-2.5 rounded-lg shadow-sm flex items-center gap-2">
